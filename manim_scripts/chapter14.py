...
Pages 85-86 of Basic Highway Plan Reading
...
MANIFEST_PATH = PROJECT_ROOT / "manifests/chapter14.json"
...
class Chapter14BaseScene(Scene):
    def render_scene(self, scene_data, manifest):
        ...
        if scene_index == 1:
            chapter_text = Text("Chapter 14", font_size=SUBTITLE_FONT_SIZE, color=MUTED_COLOR)
...
class Chapter14Full(Chapter14BaseScene):
    """Full Chapter 14 - all scenes"""
    
    def construct(self):
        manifest = load_manifest()
        print("\n" + "=" * 60)
        print(f"Chapter 14: {manifest['title']}")
        print("=" * 60)
