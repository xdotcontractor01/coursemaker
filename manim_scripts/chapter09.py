...
Pages 67-68 of Basic Highway Plan Reading
...
MANIFEST_PATH = PROJECT_ROOT / "manifests/chapter09.json"
...
class Chapter09BaseScene(Scene):
    def render_scene(self, scene_data, manifest):
        ...
        if scene_index == 1:
            chapter_text = Text("Chapter 9", font_size=SUBTITLE_FONT_SIZE, color=MUTED_COLOR)
...
class Chapter09Full(Chapter09BaseScene):
    """Full Chapter 9 - all scenes"""
    
    def construct(self):
        manifest = load_manifest()
        print("\n" + "=" * 60)
        print(f"Chapter 9: {manifest['title']}")
        print("=" * 60)
